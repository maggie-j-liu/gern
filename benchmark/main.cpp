...
BENCHMARK(BM_GernDoubleMatmul)->Repetitions(5)->MinTime(4)->MinWarmUpTime(4)
    ->Args({1, 1, 512, 512, 512, 512, 512, 512, 256})
    ->Args({1, 1, 512, 512, 512, 512, 512, 512, 512})
    ->Args({1, 1, 1024, 512, 512, 1024, 1024, 512, 512})
    ->Args({1, 1, 1024, 512, 512, 1024, 1024, 512, 1024})
    ->Args({1, 1, 1024, 1024, 1024, 1024, 1024, 1024, 256})
    ->Args({1, 1, 1024, 1024, 1024, 1024, 1024, 1024, 512})
    ->Args({1, 1, 1024, 1024, 1024, 1024, 1024, 1024, 1024});
